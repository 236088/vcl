...
void PresetFilter::display() {
	...
	//左上 学習画像
	GLbuffer::draw(gl, GL_RGB32F, GL_RGB, -1.f, -1.f, -.33333333f, 0.f);
	//中上 フィルタリング前学習画像
	GLbuffer::draw(gl_aa, GL_RGB32F, GL_RGB, -.33333333f, -1.f, .33333333f, 0.f);
	//右上 高画質学習モデル画像
	GLbuffer::draw(gl_hr, GL_RGB32F, GL_RGB, .33333333f, -1.f, 1.f, 0.f);
	//左下 目標画像
	GLbuffer::draw(gl_target, GL_RGB32F, GL_RGB, -1.f, 0.f, -.33333333f, 1.f);
	//中下 フィルタリング前目標画像
	GLbuffer::draw(gl_aa_target, GL_RGB32F, GL_RGB, -.33333333f, 0.f, .33333333f, 1.f);
	//右下 高画質目標モデル画像
	GLbuffer::draw(gl_hr_target, GL_RGB32F, GL_RGB, .33333333f, 0.f, 1.f, 1.f);
	glFlush();
}
